...
parser.add_argument('--sigma', dest='sigma', type=float, default=25.0, help='noise level for testing')

parser.add_argument('--data', dest='data', default='./data/img_clean_pats_blind.npy', help='training data path')
parser.add_argument('--data_noisy', dest='data_noisy', default='./data/img_noisy_pats_blind.npy', help='training data path')
parser.add_argument('--sigma_vector', dest='sigma_vector', default='./data/sigma_vector_0_55.npy', help='training data path')
...
def denoiser_train(denoiser, lr):
    ...
    denoiser.train(data_path=args.data, sigma_path = args.sigma_vector, data_noisy_path=args.data_noisy, eval_files=eval_files, batch_size=args.batch_size, epoch=args.epoch, lr=lr)
...
def main(_):
    ...
    name = "DnCNN_B_" + args.cost + str(args.type)
